            ...
            <div className="nav flex flex-wrap justify-between items-center font-mono">
                ...
                <div className="right-nav flex items-center lg:order-2">
                    ...
                    <div className="toogle-button ml-3 block lg:hidden ">
                        ...
                        <button className="hidden" type="checkbox" id="menu-toggle" onClick={() => setNavbarOpen(!navbarOpen)}/>
                    </div>
                </div>

                <div id="menu" className={"lg:flex-1 lg:flex items-center w-full lg:order-1 lg:py-0 lg:px-0" + (navbarOpen ? '' : ' hidden')}>
                    ...
                    <div className="right-menu lg:flex-1 lg:flex lg:justify-end">
                        <a href="#" className="nav-link lg:px-8">Sign up</a>
                        <a href="#" className="nav-link lg:px-8">Login</a>
                    </div>
                </div>
            </div>
        </div>
