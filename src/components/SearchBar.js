...
const SearchBar = ({handleClick}) => {
    ...
    return (
        <div className="p-2 py-5 mt-3 bg-gray-100 flex justify-center w-full">
            <input className="urlInput w-full md:w-1/2 text-lg p-3 border-solid border-2 rounded-md focus:outline-none focus:ring ring-yellow-400 border-orange-300" placeholder="Enter URL" value={fullUrl} onChange={(e) => {setFullUrl(e.target.value)}} />
