...
const SearchBar = ({ handleClick, setShortUrl }) => {
    ...
    return (
        <div className="mt-3 p-5 lg:px-0 flex justify-center flex-col w-full lg:w-1/2 m-auto">
            <div className="error text-red-600 animate-bounce">
            ...
            <div className="url-input sm:flex justify-center w-full lg:w-full m-auto focus-within:ring ring-yellow-500 rounded-md border border-solid border-yellow-400">
